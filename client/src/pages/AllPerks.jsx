...
*/
  ...
  // Auto-search when searchQuery or merchantFilter change (debounced)
  ...
  async function loadAllPerks(searchOverride, merchantOverride) {
    ...
    try {
      ...
      const merchantParam = (merchantOverride !== undefined) ? merchantOverride : merchantFilter
      ...
      const res = await api.get('/perks/all', {
        ...
        params: {
          ...
          // Only include search param if searchParam is not empty

          search: searchParam?.trim() || undefined,

          // Only include merchant param if merchantParam is not empty

          merchant: merchantParam?.trim() || undefined
